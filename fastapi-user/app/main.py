                        ...
                        <tbody style="display: block">
                            ...
                            <td width="100%" style="display: block; font-size: 20px">
                                ...
                                <tbody>
                                    ...
                                    <td style="display: block; margin-bottom: 10px">
                                    <a href="https://www.aivolution.link">사이트</a>에 접속하여
                                    결과를 확인해주세요.
                                    </td>
                                </tbody>
                                </table>
                        ...
                        <tbody style="display: block">
                            ...
                            <td width="100%" style="display: block; font-size: 20px">
                                ...
                                <tbody>
                                    ...
                                    <td style="display: block; margin-bottom: 10px">
                                    오류 내용을 확인하고 <a href="https://www.aivolution.link">사이트</a>에 접속하여
                                    다시 시도해주세요.
                                    </td>
                                    <td style="display: block; margin-bottom: 10px">
                    ...
                    <td width="100%" style="display: block">
                        ...
                        <tbody style="display: block">
                            ...
                            <td
                                ...
                                "
                            >
                                <a href="https://www.aivolution.link"
                                ><img
                                    width="130"
