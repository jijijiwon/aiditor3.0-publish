...
FAST_API_RT_IP_PORT = secrets['FAST_API_RT_PORT']
...
# YOLO 모델 로드
model_M = YOLO("/app/yolomodel/addf2.pt")
model_P = YOLO("/app/yolomodel/card2.pt")
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run(app, host="0.0.0.0", port=FAST_API_RT_IP_PORT, reload=True)